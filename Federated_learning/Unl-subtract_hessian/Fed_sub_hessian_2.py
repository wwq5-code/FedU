...
class LocalUpdate(object):
    def __init__(self, args, dataset=None, idxs=None, need_poison=None, poison_data=None,poison_targets=None, erased_perm=None, idx=None):
        ...
        if need_poison:
            ...
            self.poison_trainset = Data.TensorDataset(poison_data, poison_targets) #Data.TensorDataset(data, targets)
    ...
    def unlearn_Bayes(self, net, net_temp, idx, args, train_type):
        ...
        for epoch in range(self.args.local_ep+20):
            ...
            net, optimizer, acc_list = LocalUpdate.unlearning_nips(net, optimizer, self.erased_loader, remaining_loader, self.loss_func, reconstruction_function, net_temp, args ,epoch, idx, train_type)
    ...
    def unlearning_nips(net, optimizer_nips, dataloader_erase, remaining_loader, loss_fn, reconstruction_function, net_temp, args, epoch, idx, train_type):
        ...
        for   (x, y), (x2,y2) in   zip(dataloader_erase, remaining_loader)  :
            ...
            if train_type == 'unlearn':
                ...
                loss = args.beta * KLD_mean + H_p_q - log_z / e_log_py + H_p_q2 #+ args.beta * KLD_mean2
        ...
        net.eval()
        return net, optimizer_nips, acc_list
