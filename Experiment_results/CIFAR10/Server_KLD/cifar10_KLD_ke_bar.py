...
unl_fr = [42, 42 * 42/42 , 24.84*42/24.84, 28*42/28, 33.94*42/33.94]
unl_br = [41.04, 41.04* 42/42, 23.73*42/24.84, 33*42/28, 40*42/33.94]
unl_self_r = [41.16, 41.16* 42/42, 21.87*42/24.84, 36*42/28, 39*42/33.94]
unl_hess_r = [21.82,  21.82*42/42, 21.82*42/24.84, 21.82*42/28, 21.82*42/33.94]
...
plt.savefig('cifar_KLD_ke_bar.png', dpi=400)
plt.show()
