...
y_bfu_back_acc =[0.4579999953508377, 0.6059999942779541, 0.18799999728798866, 0.0, 0.0]
y_bfu_acc =  [0.9966666499773661, 0.9883333047231039, 0.9583333134651184, 0.9483333230018616, 0.9316666523615519]

y_ss_back_acc = [0.45399998426437377, 0.6099999785423279, 0.21999999284744262, 0.031999999284744264, 0.0]
...
plt.savefig('cifar_client_detail_backdoor.png', dpi=400)
plt.show()