...
unl_br = [0.08, 0.083, 0.098, 0.0748, 0.0757]
unl_self_r = [0.084, 0.08, 0.071, 0.0625 , 0.076]
unl_hess_r = [0.028,  0.028, 0.028, 0.028, 0.028]
...
plt.savefig('mnist_backacc_ur_curve.png', dpi=400)
plt.show()