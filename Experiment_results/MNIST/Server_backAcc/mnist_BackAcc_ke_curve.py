...
unl_br = [1.2, 7.04, 8., 9.51, 6.4]
unl_self_r = [1.1, 9.16, 8.4, 8.1, 1.8]
unl_hess_r = [0.79,  2.55, 2.8, 96.3, 100]
org = [99.9, 99.9, 99.9, 99.7, 99.9]
...
plt.savefig('mnist_backacc_ke_curve.png', dpi=400)
plt.show()