...
unl_br = [0.06964, 0.073, 0.059, 0.074, 0.0684]
unl_self_r = [0.05731, 0.06788, 0.0475,0.053, 0.039]
unl_hess_r = [0.0237,  0.02907, 0.0059, 0.022, 0.00543]
org = [99.9, 99.9, 99.9, 99.9, 99.8]
...
plt.savefig('mnist_backacc_clients_k_curve.pdf', format='pdf', dpi=200)
plt.show()