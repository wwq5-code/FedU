...
unl_br = [0.08*10*0.22, 0.08*10*0.22, 0.08*10*0.22, 0.08*10*0.22, 0.08*10*0.22]
unl_self_r = [0.16*10*0.22, 0.16*10*0.22, 0.16*10*0.22, 0.16*10*0.22, 0.16*10*0.22]
...
plt.savefig('mnist_client_rt_ur_bar.png', dpi=200)
plt.show()
