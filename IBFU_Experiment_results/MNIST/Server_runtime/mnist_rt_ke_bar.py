...
unl_br = [1*10*0.22, 1*10*0.22, 3*10*0.22, 2*10*0.22, 3*10*0.22]
unl_self_r = [1*10*0.22, 1*10*0.22, 2*10*0.22, 2*10*0.22, 1*10*0.22]
unl_hess_r = [1*10*0.22,  1*10*0.22, 2*10*0.22, 4*10*0.22, 3*10*0.22]
