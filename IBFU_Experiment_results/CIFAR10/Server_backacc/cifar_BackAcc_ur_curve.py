...
unl_br = [3.6, 6, 2.3, 5.4, 6]
unl_self_r = [3.9, 5.4, 5.1, 6.5, 6.7]
...
plt.plot(x, unl_br, color='orange',  marker='x',  label='CRFU',linewidth=4,  markersize=10)
plt.plot(x, unl_self_r, color='g',  marker='*',  label='CRFU-SS',linewidth=4, markersize=10)
