...
unl_br = [93.99, 90.66, 86.39, 84.99, 82]
unl_self_r = [97.99, 97.99, 96.39, 96.37, 95.9999]
unl_hess_r = [96.2,  92.14, 90.0, 88.016, 84.99]
...
plt.savefig('cifar_client_acc_er_curve.pdf', format='pdf', dpi=200)
plt.show()