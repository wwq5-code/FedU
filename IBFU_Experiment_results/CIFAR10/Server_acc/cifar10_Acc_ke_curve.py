...
labels = ['1', '2', '3', '4', '5']
unl_fr = [80.4, 80.2, 80.4, 80.0, 80.1]
unl_br = [80.12, 79.46, 78.95, 78.31, 76.32]
unl_self_r = [80.16, 80.08, 80.16, 80.09, 79.64]
unl_hess_r = [80.11,  79.24, 79.3, 78.99, 77.91]
...
plt.savefig('cifar_acc_ke_curve.pdf', format='pdf', dpi=200)
plt.show()